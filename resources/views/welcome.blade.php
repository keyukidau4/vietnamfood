        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#contact" class="smoothScroll">Cart</a></li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                @forelse ($foods as $food)
                    ...
                    <a href="#" data-lightbox-gallery="zenda-gallery"><img src="{{asset('images/gallery-img1.jpg')}}"
                                alt="gallery img"></a>
                        <div>
                ...
                @endforelse
                {{-- <div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.3s">
                    <a href="storage/app/public/images/gallery-img1.jpg" data-lightbox-gallery="zenda-gallery"><img
                            src="images/gallery-img1.jpg" alt="gallery img"></a>
                    <div>
                        <h3>Lemon-Rosemary Prawn</h3>
                        <span>Seafood / Shrimp / Lemon</span>
                    </div>
                    <a href="storage/app/public/images/images/gallery-img2.jpg"
                        data-lightbox-gallery="zenda-gallery"><img src="images/gallery-img2.jpg" alt="gallery img"></a>
                    <div>
                ...
                {{-- <div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
                    <a href="storage/app/public/images/images/gallery-img3.jpg"
                        data-lightbox-gallery="zenda-gallery"><img src="images/gallery-img3.jpg" alt="gallery img"></a>
                    <div>
                ...
                <div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.9s">
                    <a href="storage/app/public/images/images/gallery-img4.jpg"
                        data-lightbox-gallery="zenda-gallery"><img src="images/gallery-img4.jpg" alt="gallery img"></a>
                    <div>
                        <h3>Lemon-Rosemary Salad</h3>
                        <span>Chicken / Rosemary / Green</span>
                    </div>
                    <a href="storage/app/public/images/images/gallery-img5.jpg"
                        data-lightbox-gallery="zenda-gallery"><img src="images/gallery-img5.jpg" alt="gallery img"></a>
                    <div>
